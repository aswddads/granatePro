...
public class GlidUtils {
     ...
     */
    public static void loadImg(Context context,Object url,ImageView imageView,RequestOptions requestOptions) {
        Glide.with(context).load(url)
     ...
     * @param imageView      目标view
     */
    public static void loadImg(Fragment fragment,Object url,ImageView imageView,RequestOptions requestOptions) {
     ...
     */
    public static void loadImg(Context context, Object url, ImageViewTarget imageViewTarget) {
        Glide.with(context).load(url)
