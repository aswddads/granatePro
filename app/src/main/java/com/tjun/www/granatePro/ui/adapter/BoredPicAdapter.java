...
import com.tjun.www.granatePro.ui.jandan.ImageBrowseActivity;
...
import com.tjun.www.granatePro.widget.MultiImageView;
import com.tjun.www.granatePro.widget.ShowMaxImageView;
    ...
    protected void convert(final BaseViewHolder viewHolder, final JdDetailBean.CommentsBean commentsBean) {
        ...
        switch (viewHolder.getItemViewType()) {
            ...
            case JdDetailBean.CommentsBean.TYPE_SINGLE:
                ...
                GildUtils.LoadImage(mContext, commentsBean.getPics().get(0),
