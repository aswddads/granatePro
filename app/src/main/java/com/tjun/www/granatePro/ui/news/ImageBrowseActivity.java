...
import com.tjun.www.granatePro.widget.HackyViewPager;
import com.tjun.www.granatePro.widget.MyScrollView;
import com.tjun.www.granatePro.widget.SwipeBackLayout;
...
public class ImageBrowseActivity extends BaseActivity<ArticleReadPresenter> implements ArticleReadContract.View {
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            GildUtils.LoadImage(ImageBrowseActivity.this, slidesBeanList.get(position).getImage(),
